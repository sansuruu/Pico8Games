...
function preInit()
    ...
    week = 1 --this acts as the overall "ante"
    num_table = {1,2,3,4,5,6,7,8,9,0}
    submitted = false
    sub_tick = 0
    ten_ticker = 0.1 --another FUCKING ticker (10% interval for homework loading)
    ...
    base = {hw_length = 10, attent=30, dis_p=100, dis_r =0, sp=2, diff = 10}
    chosen = 0
    item_desc = {
        --common
        pencil="pencil: +speed",
...
function drawTitleScreen()
    ...
    p1("procrasti-start",34,50,7)
    p1("press ❎ to begin",32, 60, 7) 
    
    p1("BY SANSURU",44,90,6)
    p1("(CHECK DESC. FOR INFO/TUTORIAL)",3,116,6)
